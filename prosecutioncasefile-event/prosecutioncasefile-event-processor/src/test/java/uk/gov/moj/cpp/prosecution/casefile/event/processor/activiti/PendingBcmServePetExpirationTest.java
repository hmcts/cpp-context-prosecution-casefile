...
public class PendingBcmServePetExpirationTest {
    ...
    public void init() {
        ...
        pendingCpsServeBcmExpiration = new PendingCpsServeBcmExpiration(activitiExtension.getRuntimeService(), Duration.ofSeconds(1).toString());
        pendingCpsServeBcmExpiredDelegate = (JavaDelegate) activitiExtension.getProcessEngineConfiguration().getBeans().get("pendingCpsServeBcmExpiredDelegate");
