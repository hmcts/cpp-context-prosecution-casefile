...
public class AddMaterialTest extends BaseDroolsAccessControlTest {

    private static final String PROSECUTIONCASEFILE_COMMAND_ADD_MATERIAL = "prosecutioncasefile.add-material";
    ...
    @BeforeEach
    public void setUp() {
        action = createActionFor(PROSECUTIONCASEFILE_COMMAND_ADD_MATERIAL);
    }
