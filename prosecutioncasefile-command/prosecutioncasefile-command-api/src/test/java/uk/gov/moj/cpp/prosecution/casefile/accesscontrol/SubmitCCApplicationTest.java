...
public class SubmitCCApplicationTest extends BaseDroolsAccessControlTest {

    private static final String PROSECUTIONCASEFILE_COMMAND_SUBMIT_APPLICATION = "prosecutioncasefile.command.submit-application";
    private static final List<String> ALLOWED_USER_GROUPS = RuleConstants.getInitiateCCApplicationGroups();
    ...
    public SubmitCCApplicationTest() {
    ...
    @BeforeEach
    public void setUp() {
        action = createActionFor(PROSECUTIONCASEFILE_COMMAND_SUBMIT_APPLICATION);
    }
    ...
    @Test
    public void whenUserIsAMemberOfAllowedUserGroups_thenSuccessful() {
