...
public class PncIdSpiValidationRuleTest {

    private static final String TEST_INVALID_PNC_ID = "0001/1234567M";
    private static final String TEST_VALID_PNC_ID_ONE = "33444433.446k";
    private static final String TEST_VALID_PNC_ID_TWO = "334KK-33.446k";
    ...
    public void shouldReturnEmptyListWhenPNCIDNotPresent() {
        ...
        final Optional<Problem> optionalProblem = new PncIdSpiValidationRule().validate(defendantWithReferenceData, referenceDataQueryService)
    ...
    public void shouldReturnEmptyErrorListWhenValidPNCIDOne() {
        ...
        final Optional<Problem> optionalProblemOne = new PncIdSpiValidationRule().validate(defendantWithReferenceData, referenceDataQueryService)
                .problems().stream().findFirst();
    ...
    public void shouldReturnEmptyErrorListWhenValidPNCIDTwo() {
        ...
        final Optional<Problem> optionalProblemTwo = new PncIdSpiValidationRule().validate(defendantWithReferenceData, referenceDataQueryService)
                .problems().stream().findFirst();
