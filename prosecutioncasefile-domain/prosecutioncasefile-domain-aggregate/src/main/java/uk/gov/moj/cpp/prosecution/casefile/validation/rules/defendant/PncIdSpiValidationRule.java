...
import static uk.gov.moj.cpp.prosecution.casefile.validation.Constants.PNC_ID_REGEX_SPI;
...
public class PncIdSpiValidationRule implements ValidationRule<DefendantWithReferenceData, ReferenceDataQueryService> {

    private static final Pattern PNC_ID_FORMAT = Pattern.compile(PNC_ID_REGEX_SPI.getValue());
