...
public class AddMaterialV2Test extends BaseDroolsAccessControlTest {

    private static final String PROSECUTIONCASEFILE_COMMAND_ADD_MATERIAL_V2 = "prosecutioncasefile.add-material-v2";
    private static final List<String> ALLOWED_USER_GROUPS = RuleConstants.getAddMaterialActionGroups();
    ...
    @BeforeEach
    public void setUp() {
        action = createActionFor(PROSECUTIONCASEFILE_COMMAND_ADD_MATERIAL_V2);
    }
