...
public class EnterpriseIdServiceImplTest {
    ...
    @Test
    public void shouldRegenerateAnNewIdWhenIdAlreadyExistsForDifferenceCase() {
        ...
        final String logMessage = "Conflict as result for enterprise id: " + expEnterpriseId + " generated for case id: " + caseId;
