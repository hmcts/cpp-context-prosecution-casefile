...
public class CcProsecutionValidationRuleProvider {
    ...
    private static final List<ValidationRule<DefendantWithReferenceData, ReferenceDataQueryService>> SINGLE_CIVIL_CASE_ONLY_RULE_SET_FOR_SUMMONS = unmodifiableList(asList(
            new ArrestDateValidationRuleForCivil(),
            new LaidDateValidationRule(),
            new DateOfHearingPastDateValidationAndEnricherRule()
    ));

    private static final List<ValidationRule<DefendantWithReferenceData, ReferenceDataQueryService>> SINGLE_CIVIL_CASE_ONLY_RULE_SET_FOR_OTHER = unmodifiableList(asList(
            new ArrestDateValidationRuleForCivil(),
            new LaidDateValidationRule(),
    ...
    private static final Map<String, List<ValidationRule<DefendantWithReferenceData, ReferenceDataQueryService>>> defendantValidationMapForSingleCivilCases = of(
            SUMMONS.getCode(), Stream.of(SINGLE_CIVIL_CASE_ONLY_RULE_SET_FOR_SUMMONS, COMMON_DEFENDANT_RULE_SET, SPI_DEFENDANT_RULE_SET).flatMap(Collection::stream).toList(),
            OTHER.getCode(), Stream.of(SINGLE_CIVIL_CASE_ONLY_RULE_SET_FOR_OTHER, COMMON_DEFENDANT_RULE_SET, SPI_DEFENDANT_RULE_SET).flatMap(Collection::stream).toList());
