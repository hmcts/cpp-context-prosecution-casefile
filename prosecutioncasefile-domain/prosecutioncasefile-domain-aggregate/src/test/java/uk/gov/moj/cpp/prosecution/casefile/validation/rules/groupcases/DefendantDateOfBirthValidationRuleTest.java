...
public class DefendantDateOfBirthValidationRuleTest {
    ...
    public void shouldNotReturnAnyValidationErrorsWhenDoBIsPresentAndInThePast() {
        ...
        final ValidationResult problem = defendantDateOfBirthValidationRule.validate(groupProsecutionList, referenceDataQueryService);
    ...
    public void shouldNotReturnAnyValidationErrorsWhenDoBIsNotPresent() {
        ...
        final ValidationResult result = defendantDateOfBirthValidationRule.validate(groupProsecutionList, referenceDataQueryService);
    ...
    public void shouldReturnValidationErrorWhenDoBIsInFuture() {
        ...
        final GroupProsecution groupProsecution1 = GroupProsecution.groupProsecution()
                ...
                .withDefendants(Arrays.asList(Defendant.defendant()
                        ...
                        .withIndividual(Individual.individual()
                                .withSelfDefinedInformation(SelfDefinedInformation.selfDefinedInformation()
                                        .withDateOfBirth(LocalDate.now().plusDays(20))
                                        .build())
                                .build())
                        .withOffences(Arrays.asList(Offence.offence()
                                .withOffenceId(offenceId1)
        ...
        assertThat(problem.getCode(), is("DEFENDANT_DOB_IN_FUTURE"));
