...
public class PendingMaterialExpirationTest {
    ...
    public void init() {
        ...
        pendingMaterialExpiration = new PendingMaterialExpiration(rule.getRuntimeService(), Duration.ofSeconds(1).toString());
        pendingMaterialExpiredDelegate = (JavaDelegate) configuration.getBeans().get("pendingMaterialExpiredDelegate");
