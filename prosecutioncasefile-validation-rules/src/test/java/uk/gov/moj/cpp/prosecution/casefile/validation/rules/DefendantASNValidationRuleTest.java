...
public class DefendantASNValidationRuleTest {
    ...
    @InjectMocks
    private final DefendantASNValidationRule defendantASNValidationRule = new DefendantASNValidationRule();


    @BeforeEach
    public void setup() throws IllegalAccessException {
        List<SubmitApplicationValidationRule> validationRules = singletonList(defendantASNValidationRule);
        when(validatorRules.spliterator()).thenReturn(validationRules.spliterator());
    }

    @Test
    public void shouldNotRaisedErrorCode_whenDefendantASNGiven_andIsDefendantMatchIsTrue() {
    ...
    @Test
    public void shouldNotRaisedErrorCode_whenDefendantASNIsEmpty_andIsDefendantMatchIsTrue() {
        final SubmitApplication submitApplication = submitApplication()
                .withCourtApplication(courtApplication()
                        .withId(randomUUID())
                        .withRespondents(singletonList(respondent()
    ...
    @Test
    public void shouldNotRaisedErrorCode_whenDefendantASNIsNull_andIsDefendantMatchIsFalse() {
        final SubmitApplication submitApplication = submitApplication()
                .withCourtApplication(courtApplication()
                        .withId(randomUUID())
                        .withRespondents(singletonList(respondent()
    ...
    @Test
    public void shouldRaisedErrorCode_whenDefendantASNGiven_andIsDefendantMatchIsFalse() {
        final SubmitApplication submitApplication = submitApplication()
                .withCourtApplication(courtApplication()
                        .withId(randomUUID())
                        .withRespondents(singletonList(respondent()
        ...
        assertThat(validationError.get(0).get(), is(ValidationError.DEFENDANT_ASN_NOT_FOUND));
    }


    @Test
    public void shouldNotRaisedErrorCode_whenMultipleDefendantASNsMatch_andIsDefendantMatchIsTrue() {
        final SubmitApplication submitApplication = submitApplication()
                .withCourtApplication(courtApplication()
                        .withId(randomUUID())
                        .withRespondents(asList(respondent()
                                        .withAsn("arrest222")
                                        .withIsDefendantMatched(true)
                                        .build(),
                                respondent()
    ...
    @Test
    public void shouldRaisedErrorCode_whenMultipleDefendantASNsMatch_andOneOrMoreIsDefendantMatchIsFalse() {
        final SubmitApplication submitApplication = submitApplication()
                .withCourtApplication(courtApplication()
                        .withId(randomUUID())
                        .withRespondents(asList(respondent()
