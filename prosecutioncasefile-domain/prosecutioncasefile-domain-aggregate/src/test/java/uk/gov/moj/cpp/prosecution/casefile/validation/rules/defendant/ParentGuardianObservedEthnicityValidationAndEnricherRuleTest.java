...
public class ParentGuardianObservedEthnicityValidationAndEnricherRuleTest {
    ...
    public void shouldReturnEmptyListWhenObservedEthnicityMatches() {
        ...
        final ObservedEthnicityReferenceData observedEthnicityReferenceData = new ObservedEthnicityReferenceData(ethnicityCode,
    ...
    @Test
    public void shouldReturnViolationWhenObservedEthnicityDoesNotMatch() {
        final String ethnicityCode = "1";
