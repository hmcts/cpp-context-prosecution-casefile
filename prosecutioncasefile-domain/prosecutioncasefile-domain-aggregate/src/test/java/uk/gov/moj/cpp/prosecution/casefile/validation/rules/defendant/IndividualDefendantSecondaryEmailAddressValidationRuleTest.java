...
public class IndividualDefendantSecondaryEmailAddressValidationRuleTest {
    ...
    private Defendant getIndividualWithNoSecondaryEmail() {
        return defendant()
    ...
    private Defendant getIndividualWithValidSecondaryEmail() {
        return defendant()
                .withIndividual(individual()
                        .withPersonalInformation(personalInformation()
    ...
    private Defendant getIndividualWithInvalidSecondaryEmail() {
        return defendant()
                .withIndividual(individual()
                        .withPersonalInformation(personalInformation()
