...
public class PendingIdpcMaterialExpiredDelegateTest {
    ...
    @InjectMocks
    private PendingIdpcMaterialExpiredDelegate pendingIdpcMaterialExpiredDelegate;
    ...
    public void sendsExpirePendingMaterialCommand() {
        ...
        pendingIdpcMaterialExpiredDelegate.execute(delegateExecution);
        ...
        assertThat(capturedAddDocumentCommandEnvelope,
                jsonEnvelope(
                        metadata().withName("prosecutioncasefile.command.expire-pending-idpc-material"),
                        payloadIsJson(allOf(
                                withJsonPath("$.caseId", equalTo(caseId.toString())),
                                withJsonPath("$.fileServiceId", equalTo(fileStoreId.toString())))
                        )));
    }
